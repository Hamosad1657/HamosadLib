...
package com.hamosad1657.lib.vision.limelight;
...
public class Limelight {
	...
	public static boolean hasTargets(String limelightName) {
		return getLimelightNTTableEntry(limelightName, "v").getBoolean(false);
	}

	public static boolean connectionStatus(String limelightName) {
		getLimelightNTTable(limelightName).getEntry("tl").setValue(0.0);
		Timer.delay(0.05);
		if (getLatency_Pipeline(limelightName) == 0.0) {
			return false;
		} else {
			return true;
		}
	...
	public static Pose3d getBotpose_wpiRed(String limelightName) {
		double[] botPose = getLimelightNTDoubleArray(limelightName, "botpose_wpired");
		return new Pose3d(botPose[0], botPose[1], botPose[2],
